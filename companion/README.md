...
- Popover rows use a terminal-style layout with project name, task name, task memo, repo name, repo branch, a warm current status line with `HH:mm` update time, and the task status checklist items.
