...
>
> **시리즈 위치:** menu bar companion initiative의 첫 번째 핵심 CLI 계약이다. 0016 focus/open-warp 계획은 제거되었고, 현재 실행 순서는 **0015 → 0017 메모 우선 companion → 0018 companion 배포 배관**이다. 0018은 companion 공개 배포가 필요할 때만 실행한다.
